...
$${\color{red}Two \space \color{red}opennings \space \color{red}for \space \color{red}Fall \space \color{red}2026}$$
[$${\color{red}Two \space \color{red}opennings \space \color{red}for \space \color{red}Fall \space \color{red}2026}$$]Two opennings for Fall 2026: 1 for computer vision/medical image computing, 1 for AI-augmented Cardiac MRI imaging.
...
# Group Members
PhD Students:
- Chenchuhui Hu (BS, UC Davis; MS, Brandeis University) 
- Shaoming Pan (BE, Shanghai Jiao Tong University) 
